...
public sealed partial class CENodeTreeGraphControl : BoxContainer
{
    ...
    protected override void Draw(DrawingHandleScreen handle)
    {
        ...
        foreach (var node in _state.Nodes)
        {
            ...
            // Frame
            var frameTexture = _sprite.Frame0(_state.FrameIcon);
            ...
            {
                var selectedTexture = _sprite.Frame0(_state.SelectedIcon);
            ...
            {
                _hoveredNode = node;
                var hoveredTexture = _sprite.Frame0(_state.HoveredIcon);
            ...
            if (node.Gained)
            {
                var learnedTexture = _sprite.Frame0(_state.LearnedIcon);
            ...
            {
                var baseTexture = _sprite.Frame0(node.Icon);
