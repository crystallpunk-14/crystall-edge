...
ce-entity-effect-guidebook-flash = Flashes and stuns the target
...
ce-entity-effect-guidebook-shockwave-vfx = Creates a visual shockwave effect
ce-entity-effect-guidebook-weapon-effect-slot = Triggers the weapon's linked effects
...
ce-entity-effect-guidebook-change-mana-restore = Restores [color=yellow]{ $amount }[/color] mana
ce-entity-effect-guidebook-change-mana-drain = Drains [color=yellow]{ $amount }[/color] mana
ce-entity-effect-guidebook-spawn-entity = Spawns [color=yellow]{ $entities }[/color]
ce-entity-effect-guidebook-spawn-in-hand = Spawns [color=yellow]{ $entities }[/color] into the target's hand
