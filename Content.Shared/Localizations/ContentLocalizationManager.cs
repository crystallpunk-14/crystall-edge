...
namespace Content.Shared.Localizations
{
    public sealed partial class ContentLocalizationManager
    {
        ...
        // CrystallEdge: server language is configurable via CCVars.ServerLanguage instead of a hardcoded Culture const
        ...
        public void Initialize()
        {
            ...
            //CrystallEdge Boilerplate! Should be deleted when https://github.com/space-wizards/space-station-14/pull/34404 is merged
            _loc.Initialize();
            //CrystallEdge Boilerplate end
