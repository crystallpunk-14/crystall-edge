...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class KeyRebindTab : Control
    {
        ...
        public KeyRebindTab()
        {
            ...
            AddButton(CEContentKeyFunctions.OpenBelt2); //CrystallEdge
            AddButton(CEContentKeyFunctions.SmartEquipBelt2);  //CrystallEdge
            ...
            AddButton(CEContentKeyFunctions.OpenSkillMenu); //CrystallEdge
