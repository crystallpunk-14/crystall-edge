ce-roles-antag-vampire-name = Высший вампир
ce-roles-antag-vampire-objective = Этот город - ваша территория. Избавьтесь от других вампиров любыми методами. Ну а обычные смертные... лишь ресурс в вашей войне, которым вы можете пользоваться по своему усмотрению.
