using Content.Client._CE.UserInterface.Systems.Skill;
...
public sealed class GameTopMenuBarUIController : UIController
{
    ...
    [Dependency] private readonly CESkillUIController _skill = default!; //CrystallEdge
    ...
    public void UnloadButtons()
    {
        ...
        _skill.UnloadButton(); //CrystallEdge
    }
    ...
    public void LoadButtons()
    {
        ...
        _sandbox.LoadButton();
        _emotes.LoadButton();
        _skill.LoadButton(); //CrystallEdge
    }
}
