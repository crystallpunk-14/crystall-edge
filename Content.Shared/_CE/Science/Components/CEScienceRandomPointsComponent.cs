...
/// then distributes a random total point budget rolled from <see cref="Amount"/> across those 3
/// types 70%/20%/10% - the same weighting a magic essence node uses for its own 3 rolled aspects -
/// and writes the result into the entity's <see cref="CEScientificInterestComponent.Points"/>.
/// </summary>
[RegisterComponent]
public sealed partial class CEScienceRandomPointsComponent : Component
{
    [DataField]
    public MinMax Amount = new(10, 30);
}
