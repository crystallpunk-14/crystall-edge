        ...
        await client.WaitAssertion(() =>
        {
            ...
            Assert.Multiple(() =>
            {
                foreach (var proto in protos)
                {
                    ...
                    //if (!string.IsNullOrEmpty(visuals.FillBaseName) && visuals.MaxFillLevels > 0) //TODO: CrystallEdge removed it, because vanilla tet checks ony BaseRSI, not layer RSI (its broken for apple trees for example)
                    //{
