...
[Virtual]
public partial class CEStylesheet : CommonStylesheet
{
    public override string StylesheetName => "CEStylesheet";

    public override NotoFontFamilyStack BaseFont { get; }


    public static readonly ResPath TextureRoot = new("/Textures/_CE/Interface/CEStyle");
    ...
    public CEStylesheet(object config, StylesheetManager man) : base(config)
    {
